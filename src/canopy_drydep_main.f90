...
subroutine GetDryDepExCoeffs(vd)
    ...
    !get input data from 5m to 40m, every 5m interval
    pmb    = (/1012.66     , 1012.07     , 1011.48     , 1010.891    , 1010.292    , 1009.702    , 1009.111    , 1008.522    /)              !calc use barometric formula
    lai    = (/0.444595E+01, 0.395672E+01, 0.331488E+01, 0.211422E+01, 0.148396E+01, 0.392690E+01, 0.000000E+00, 0.000000E+00/)              !data from CANACC
